...
# Spec: AI Robotics Book RAG Chatbot
...
This document specifies the requirements for a RAG (Retrieval-Augmented Generation) chatbot integrated into the "Physical AI and Humanoid Robotics" Docusaurus book. The chatbot will allow readers to ask questions about the book's content and receive contextually relevant answers.
...
- **Backend Server Access**: The FastAPI backend server, when running locally, is accessible via:
